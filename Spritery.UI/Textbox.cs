...
public sealed class Textbox
{
    ...
    public event EventHandler? TextConfirmedEvent;
    public event EventHandler? TextAbortedEvent;

    public TextboxProperties Properties { get; set; } = new();
    ...
    private void OnTextConfirmedEvent()
    {
        ...
        TextConfirmedEvent?.Invoke(this, EventArgs.Empty);
    }
    ...
    private void OnTextAbortedEvent()
    {
        ...
        TextAbortedEvent?.Invoke(this, EventArgs.Empty);
    }
}

public sealed class TextboxProperties : Properties
{
